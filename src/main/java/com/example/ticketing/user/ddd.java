...
import com.example.ticketing.ticketing.TicketService;
...
public class TicketServiceImpl implements TicketService {
    ...
    public int numSeatsAvailable(final String venueLevel) {
        LOGGER.debug("Finding number of seats available for the venue level {}", venueLevel); //가능좌석수
    ...
    private void removeExpiredHoldSeats() { //만료된 좌석 제거
    ...
    private Instant getExpirationInstant() { // 만료된 좌석 조회
